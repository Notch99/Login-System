        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if (exchange.getRequestMethod().equalsIgnoreCase("GET")) {
                ...
                for (UUID uuid : passwords.keySet()) {
                    ...
                    String playerName = loginSystem.getPlayerName(net.neoforged.neoforge.server.ServerLifecycleHooks.getCurrentServer(), uuid);
                    ...
                    if (net.neoforged.neoforge.server.ServerLifecycleHooks.getCurrentServer() != null) {
                        ServerPlayer playerEntity = net.neoforged.neoforge.server.ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayer(uuid);
