        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if (exchange.getRequestMethod().equalsIgnoreCase("GET")) {
                ...
                for (UUID uuid : passwords.keySet()) {
                    ...
                    String playerName = loginSystem.getPlayerName(net.minecraftforge.server.ServerLifecycleHooks.getCurrentServer(), uuid);
                    ...
                    if (net.minecraftforge.server.ServerLifecycleHooks.getCurrentServer() != null) {
                        ServerPlayer playerEntity = net.minecraftforge.server.ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayer(uuid);
